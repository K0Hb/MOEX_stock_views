...
def yahoo_get_api(ticker):
    url = f'https://query2.finance.yahoo.com/v10/finance' \
          f'/quoteSummary/{ticker}?modules=price'
    headers = 'Mozilla/5.0 '
...
all_rus_stocks = ['SBER', 'GAZP', 'LKOH', 'YANDX', 'GMKN', 'MTSS',
                  'ALRS', 'NLMK', 'MAGN', 'VTBR', 'OZON', 'POLY',
                  'TCSG', 'SBERP', 'VKCO', 'MOEX', 'CHMF', 'ROSN',
                  'AFLT', 'NVTK', 'TATN', 'PLZL', 'DSKY', 'FIVE',
                  'AFKS', 'RUAL', 'MTLP', 'MVID', 'PHOR', 'IRAO',
                  'SHGSP', 'PIKK', 'SIBM', 'SNGS', 'FEES', 'AGRO',
                  'RASP', 'SGZH', 'HYDR', 'RSTI', 'TATNP', 'GLTR',
                  'FIXP', 'POGR', 'BANEP', 'RTKM', 'AKRN', 'MTLRP',
                  'SNGSP']

blue_stoks = ['SBER', 'GAZP', 'LKOH', 'YANDX', 'GMKN', 'NVTK',
              'TATNP', 'MOEX', 'VTBR', 'SNGS', 'ALRS']
