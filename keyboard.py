...
indexs_buttons = ['/РТС', '/Мосбиржа_индекс', '/SP500', '/NASDAQ', '/DJI', '/DAX', '/IBOVESPA', '/KOSPI', '/Nikkei']
currencies_buttons = ['/USD/RUB', '/EUR/RUB', '/RUB/CNY', '/EUR/USD', '/USD/JPY', '/USD/CNY', '/BTC/USD']
...
def generate_keyboard(buttons_name=None, back=False):
